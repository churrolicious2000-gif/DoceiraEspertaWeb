export function Footer() {
  return (
    <footer className="bg-cream py-16 text-chocolate-light">
      <div className="container mx-auto px-4 text-center">
        <h3 className="text-3xl font-serif font-bold mb-6 text-chocolate">Doceira Esperta | Achadinhos para Confeitaria</h3>
        ...
        <div className="w-full h-px bg-chocolate/10 mb-10" />
